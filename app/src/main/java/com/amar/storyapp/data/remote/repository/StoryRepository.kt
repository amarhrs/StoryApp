package com.amar.storyapp.data.remote.repository
...
import com.amar.storyapp.data.remote.response.ErrorResponse
import com.amar.storyapp.data.remote.retrofit.ApiService
import com.amar.storyapp.data.Result
import com.amar.storyapp.data.local.StoryDatabase
import com.amar.storyapp.data.local.StoryRemoteMediator
import com.amar.storyapp.data.remote.response.ListStoryItem
import com.amar.storyapp.data.remote.response.LoginResult
import com.amar.storyapp.data.remote.retrofit.ApiConfig
import com.amar.storyapp.util.reduceFileImage
import com.amar.storyapp.util.wrapEspressoIdlingResource
...
class StoryRepository private constructor(
    ...
    fun getStoriesWithPaging(coroutineScope: CoroutineScope): LiveData<Result<PagingData<ListStoryItem>>> =
        liveData {
            emit(Result.Loading)
            try {
    ...
    fun uploadStory(getFile: File?, description: String, lat: Float? = null, lon: Float? = null): LiveData<Result<ErrorResponse>> =
        liveData {
            emit(Result.Loading)
            try {
                if (getFile != null) {
